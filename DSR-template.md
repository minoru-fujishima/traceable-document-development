...
> This template is a lightweight starting point for Traceable Document Development (TDD).  
> Keep only the fields and sections that are useful for the document being developed.
...
- **Status:** [Accepted / Conditional / Hypothesis / other, if useful]
- **Condition / Limitation:** [if needed]
- **Source:** [where the information came from, if needed]
- **Evidence:** [what supports the claim, if needed]
- **Derivation:** [how the claim was derived, if needed]
- **Rationale:** [why this interpretation or decision was adopted, if needed]
...
Keep only rejected claims that remain plausible enough to be accidentally reused, or whose rejection is important for maintaining the current Document State.

**NK01.** [Rejected or excluded claim]

- **Disposition:** [Rejected / Not Selected, if useful]
- **Reason:** [why it must not be used, if needed]

**NK02.** [Rejected or excluded claim]
...
Record changes when version tracking is useful.

| DSR version | Date | Change |
| --- | --- | --- |
| v1 | YYYY-MM-DD | Initial Document State |
|  |  |  |
